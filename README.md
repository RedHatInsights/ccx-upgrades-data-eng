...
1. Apply a ML model (running in [ccx-upgrades-inference](https://gitlab.cee.redhat.com/ccx/ccx-inference-service))
...
Definition of the dashboard for this service and the [inference](https://gitlab.cee.redhat.com/ccx/ccx-inference-service) one is located in [dashboards](dashboards).
