...
COMPONENT_NAME="ccx-upgrades-data-eng"  # name of app-sre "resourceTemplate" in deploy.yaml for this component
IMAGE="quay.io/cloudservices/ccx-upgrades-data-eng"
COMPONENTS="ccx-upgrades-data-eng ccx-upgrades-inference ccx-insights-results dvo-writer valkey-writer ccx-smart-proxy ccx-mock-ams ccx-upgrades-rhobs-mock ccx-upgrades-sso-mock" # space-separated list of components to laod
...
export IQE_MARKER_EXPRESSION="(upgrades and not ui)"
