...
COMPONENTS="ccx-upgrades-data-eng ccx-upgrades-inference dvo-writer insights-results-smart-proxy ccx-mock-ams ccx-upgrades-rhobs-mock ccx-upgrades-sso-mock" # space-separated list of components to laod
